...
import cn.com.fanyu.huanxin.api.IMUserAPI;
...
public class EasemobIMUsers  implements IMUserAPI {
	...
	@Override
	public Object createNewIMUserSingle(final Object payload) throws BusinessException {
		return responseHandler.handleCopy(new EasemobAPI() {
			@Override
