...
public class ResponseHandler {
    ...
    public Object handleCopy(EasemobAPI easemobAPI) throws BusinessException {
        Object result = null;
        try {
            result = easemobAPI.invokeEasemobAPI();
        } catch (ApiException e) {
            ...
            Map<String, String> map = gson.fromJson(e.getResponseBody(), Map.class);
            logger.error("error_code:{} error_msg:{} error_desc:{}", e.getCode(), e.getMessage(), map.get("error_description"));
            //return "error_code:"+e.getCode()+" error_msg:"+e.getMessage()+" error_desc:"+ map.get("error_description");
//            return new ResultJson(e.getCode(), "", " error_msg:"+e.getMessage()+" error_desc:"+ map.get("error_description"), "").toString();
            throw new BusinessException(e.getCode()," error_msg:"+e.getMessage()+" error_desc:"+ map.get("error_description"));
        }
        return result;
    }
