...
public class TokenUtil {
    ...
    public void setConfigFile(String configFile) {
        TokenUtil.configFile = configFile;

        InputStream inputStream = TokenUtil.class.getClassLoader().getResourceAsStream(configFile);
     ...
     */
    static {
//        InputStream inputStream = TokenUtil.class.getClassLoader().getResourceAsStream("config-test.properties");
//        Properties prop = new Properties();
//        try {
//            prop.load(inputStream);
//        } catch (IOException e) {
